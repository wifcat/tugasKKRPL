...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "UPDATE pegawai SET nama='$nama', umur='$umur' WHERE id=$id";
        $koneksi->query($sql);
        header("Location: tampil_data2.php?status=success");
        exit();
    } catch (Exception $e) {
    ...
    $id = $_GET['id'];
    $query = $koneksi->query("SELECT * FROM pegawai WHERE id = $id");
...
<body class="p-5">
    <div class="container blur-box">
        ...
        <form action="edit2.php" method="POST" class="row g-3">
